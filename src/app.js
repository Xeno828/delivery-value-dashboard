...
function renderForecast() {
  ...
  const ctrl = q === "sequence" ? "" : q === "when"
    ? '<div class="fc-ask"><label for="fc-items">How many items?</label>' +
      ...
      (S.fcItems != null
        ? '<button type="button" class="linkish" data-fc-reset="items">Use this sprint\'s ' +
    ...
    : '<div class="fc-ask"><label for="fc-date">By what date?</label>' +
      ...
      (S.fcDate
        ...
        : '<span class="note">The end of the selected ' + (M_FLOW() ? "window" : "sprint") +
          '. Change it to ask about any date.</span>') +
      "</div>";
