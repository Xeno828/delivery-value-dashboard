...
function renderHeader(m) {
  ...
  const live = meta.source && meta.source !== "demo";
  const sb = $("#t-src");
  sb.querySelector(".dot").style.background = live ? CSSV("--good") : CSSV("--warning");
  sb.querySelector("span:last-child").textContent = meta.sourceLabel ||
    (live ? "Live: " + meta.source : "Demo data");
