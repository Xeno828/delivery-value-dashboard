...
function derive(items) {
  ...
  const statusFiltered = !!S.filters.status;
...
function renderKpis(m) {
  ...
  const tiles = [
    ...
    m.isFlowBoard
      ...
      delta: (filtersActive() || (S.view.ctx && S.view.ctx.isRollup)) ? null : arrow(spDelta, true, cv(cur), cv(prev)),
